                                    	...
                                    	<tr>
                                        	<td valign="top">
                                            	<div mc:edit="std_preheader_content">
                                                	 Welcome to Movie Notifications, please verify your email address
                                                </div>
                                            </td>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <div mc:edit="std_content00">
                                                                <h1 class="h1">Welcome to Movie Notifications</h1>
                                                                Hi <?=$name?>,

                                                                <p>Thanks for registering to Movie Notifications. Your account is just a few minutes away from being setup and ready to receive notifications.</p>

                                                                <p>To verify your email address, please click the link below.</p>

                                                                <p><a href="<?=$url?>"><?=$url?></a></p>

                                                                <p>If you did not register to Movie Notifications then you may disregard this email, your email address will not be used.</p>
