...
<html>
    <head>
        ...
        <title>DVD Release Notification for <?=$title?></title>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <div mc:edit="std_content00">
                                                                ...
                                                                <p>Just a quick message to let you know that <?=$title?> is released to DVD <?=$when?>.</p>

                                                                <p><?=$title?> is released on <?=date('jS M Y', strtotime($date))?>.</p>

                                                                <? if ($link): ?><p>You can buy the DVD for this movie at <?=$link?></p><? endif; ?>
