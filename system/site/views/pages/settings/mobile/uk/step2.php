                                          ...
                                          <div class="inner">
											...
											<p>Lovely, we have just sent a text message to <strong><?=$this->user_m->meta('mobile_number')?></strong> with a verification code. When you receive the message, please enter the code below.</p>
												<fieldset>
									            	...
									            	<?=form_error('code')?>
									            	<button type="submit"><span><em><b>verify mobile</b></em></span></button> <button id="link" type="button" href="<?=site_url('settings/mobile/uk')?>?cancel=1&mobile=<?=$this->user_m->meta('mobile_number')?>"><span><em><b>cancel verification</b></em></span></button>
									            </fieldset>
											<?=form_close()?>
                                            </div>
                                          </div>
